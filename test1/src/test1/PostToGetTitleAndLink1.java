...
public class PostToGetTitleAndLink1
{

	public void PostToGetTitleAndLink111()
	{
		...
		for( Element link : links )
		{
			...
			aa.append( link.text() );
			System.out.println( "aaaaaaaa: " + link.text() );
			aa.append( "\n" );
			aa.append( url + link.attr( "href" ) );

			System.out.println( "aaaaaaaa: " + url + link.attr( "href" ) );
	...
	public static StringBuffer name()
	{
		...
		try
		{
			FileReader fr = new FileReader( "d:\\PostToGetTitleAndLink\\txt\\input.txt" );
	...
	{
		File saveFile = new File( "d:\\PostToGetTitleAndLink\\txt\\output.txt" );
		try
		{
